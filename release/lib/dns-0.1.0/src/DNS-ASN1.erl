...
%% Purpose: encoder and decoder to the types in mod DNS-ASN1
...
-asn1_info([{vsn,'4.0.4'},
            {module,'DNS-ASN1'},
            {options,[{i,"/host/_build/default/lib/dns/asngen"},
 ber,
 {outdir,"/host/_build/default/lib/dns/asngen"},
 {i,"."},
 {i,"/host/_build/default/lib/dns/asn1"}]}]).
